...
var $author$project$PhotoGroove$initialModel = {activity: '', choosenSize: $author$project$PhotoGroove$Medium, hue: 5, noise: 5, ripple: 5, status: $author$project$PhotoGroove$Loading};
						...
						case 'BadUrl':
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										status: $author$project$PhotoGroove$Errored('BadUrl: ' + errorMessage)
									}),
								$elm$core$Platform$Cmd$none);
						case 'Timeout':
							var _v4 = msg.a.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										status: $author$project$PhotoGroove$Errored('Timeout')
									}),
								$elm$core$Platform$Cmd$none);
						case 'NetworkError':
							var _v5 = msg.a.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										status: $author$project$PhotoGroove$Errored('NetworkError')
									}),
								$elm$core$Platform$Cmd$none);
						case 'BadStatus':
							var errorMessage = msg.a.a.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										status: $author$project$PhotoGroove$Errored(
						...
						default:
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										status: $author$project$PhotoGroove$Errored('BadBody: ' + errorMessage)
									}),
								$elm$core$Platform$Cmd$none);
					}
				}
