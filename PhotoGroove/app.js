...
var $author$project$PhotoGroove$SelectedIndexReceived = function (a) {
	return {$: 'SelectedIndexReceived', a: a};
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SurpriseMeClicked':
				return _Utils_Tuple2(
					model,
					A2($elm$random$Random$generate, $author$project$PhotoGroove$SelectedIndexReceived, $author$project$PhotoGroove$randomPhotoPicker));
			default:
				var index = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$PhotoGroove$SurpriseMeClicked = {$: 'SurpriseMeClicked'};
...
var $author$project$PhotoGroove$SizeClicked = function (a) {
	return {$: 'SizeClicked', a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$PhotoGroove$SizeClicked(size))
					]),
				_List_Nil),
				$elm$html$Html$text(
...
var $author$project$PhotoGroove$PhotoClicked = function (a) {
	return {$: 'PhotoClicked', a: a};
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onClick(
					$author$project$PhotoGroove$PhotoClicked(thumb.url))
				]),
			_List_Nil);
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$PhotoGroove$SurpriseMeClicked)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$author$project$PhotoGroove$sizeToClass(model.choosenSize))
					]),
				A2(
					$elm$core$List$map,
